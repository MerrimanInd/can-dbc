...
impl DBCObject for DBC {
    fn dbc_string(&self) -> String {
        ...
        // Symbols
        file_str.push_str(&self.new_symbols.dbc_string());
        ...
        file_str.push_str(&dbc_vec_to_string::<MessageTransmitter>(
            &self.message_transmitters,
            " ",
        ));

        // Environment Variables
        file_str.push_str(&dbc_vec_to_string::<EnvironmentVariable>(
            &self.environment_variables,
            "",
        ));
        file_str.push_str(&dbc_vec_to_string::<EnvironmentVariableData>(
        ...
        // Attributes
        file_str.push_str(&dbc_vec_to_string::<AttributeDefault>(
            &self.attribute_defaults,
            "",
        ));
        file_str.push_str(&dbc_vec_to_string::<AttributeDefinition>(
            &self.attribute_definitions,
            "",
        ));
        file_str.push_str(&dbc_vec_to_string::<AttributeValueForObject>(
            &self.attribute_values,
            "",
        ));

        // Value Descriptions
        file_str.push_str(&dbc_vec_to_string::<ValueDescription>(
            &self.value_descriptions,
            "",
        ));

        // Signal Attributes
        file_str.push_str(&dbc_vec_to_string::<SignalTypeRef>(
            &self.signal_type_refs,
            "",
        ));
        ...
        // Multiplex
        file_str.push_str(&dbc_vec_to_string::<ExtendedMultiplex>(
            &self.extended_multiplex,
            "",
        ));
...
fn new_symbols_test() {
    ...
    let (_, symbols) = Symbols::parse(def).unwrap();

    // Test parsing
    assert_eq!(symbols_exp, symbols.0);
